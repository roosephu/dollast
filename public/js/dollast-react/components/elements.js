...
(function(){
  var createClass, ref$, getAttr, mergeProp, addClassName, classnames, log, labeledIcon, iconText, iconInput, ui, field, tabMenu, labelField, dropdown, statistics, labelSegment, loadingSegment, out$ = typeof exports != 'undefined' && exports || this;
  ...
  out$.loadingSegment = loadingSegment = createClass({
    displayName: 'loading-segment',
    render: function(){
      var classes;
      classes = classnames('ui', 'segment', {
        loading: this.props.status === 'wait'
      });
      return _('div', {
        className: classes
      }, this.props.children);
