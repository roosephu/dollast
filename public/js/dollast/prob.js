...
(function(){
  var probApp;
  probApp = angular.module('dollast-prob-app', ["doffirst", "ngFileUpload"]);
  ...
  probApp.controller('prob-modify-ctrl', [
    "$scope", "doffirst", "$routeParams", "$upload", function($scope, doffirst, $routeParams, $upload){
      var that, pid;
      ...
      return $scope.$watch('uploadFile', function(oldVal, newVal){
