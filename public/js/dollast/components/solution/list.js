...
(function(){
  var createClass, connect, ref$, iconText, codeLink, probLink, userLink, onGetSolutionsList, I, selector;
  createClass = require('react').createClass;
  connect = require('react-redux').connect;
  ref$ = require('../elements'), iconText = ref$.iconText, codeLink = ref$.codeLink, probLink = ref$.probLink, userLink = ref$.userLink;
      ...
      return _('div', null, _('h1', {
        ...
        for (i$ = 0, len$ = (ref$ = sols).length; i$ < len$; ++i$) {
          ...
          results$.push(_('tr', {
            ...
            pid: sol.prob._id,
            title: sol.prob.outlook.title
          })), _('td', null, _(userLink, {
            user: sol.user
          })), _('td', null, sol.final.status), _('td', null, sol.final.score), _('td', null, sol.final.time), _('td', null, sol.final.space), _('td', null, sol.lang), _('td', null, (ref1$ = sol.round) != null ? ref1$._id : void 8)));
        }
        return results$;
      }()))), _(iconText, {
