...
(function(){
  var createClass, connect, ref$, iconText, loadingSegment, codeLink, probLink, userLink, rndLink, onGetSolutionsList, fromJS, classnames, log, selector;
  ...
  selector = function(state){
    return {
      sols: state.getIn(['db', 'solution', 'get'], fromJS([])),
      status: state.getIn(['status', 'solution', 'get'], 'init')
    };
  };
  module.exports = connect(selector)(createClass({
    ...
    render: function(){
      ...
      }, 'status'), _(loadingSegment, {
        status: this.props.status
      }, _('table', {
        className: "ui table large green selectable very basic"
