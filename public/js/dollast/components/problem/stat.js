...
(function(){
  var createClass, connect, I, ref$, statistics, iconText, probLink, onGetProblemStat, sortWith, average, map, filter, log, selector, generateStat;
  ...
  ref$ = require('prelude-ls'), sortWith = ref$.sortWith, average = ref$.average, map = ref$.map, filter = ref$.filter;
