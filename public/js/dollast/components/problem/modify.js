...
(function(){
  var createClass, connect, I, ref$, onUpdateProblem, onGetProblem, onUploadFiles, onRepairProblem, toClientFmt, field, iconText, labelField, dropdown, loading, dropzone, log, selector;
  ...
  module.exports = connect(selector)(createClass({
    ...
    updateForms: function(problem){
      var $form;
      log('new states. setting new values for form...', problem.toJS());
    ...
    render: function(){
      ...
      return _('div', {
        ...
        onDrop: this.onDrop
      }, _('div', null, "drop files here for click to select"))), _(field, {
