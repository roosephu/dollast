...
(function(){
  var createClass, connect, onRefreshProblemList, ref$, iconText, tabMenu, probLink, dropdown, U, I, log, linkList, selector;
  createClass = require('react').createClass;
  connect = require('react-redux').connect;
  onRefreshProblemList = require('../../actions').onRefreshProblemList;
  ref$ = require('../elements'), iconText = ref$.iconText, tabMenu = ref$.tabMenu, probLink = ref$.probLink, dropdown = ref$.dropdown;
  U = require('../utils');
  I = require('immutable');
