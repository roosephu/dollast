...
(function(){
  var createClass, connect, I, ref$, iconText, roundTime, rndLink, probLink, labelSegment, onGetUserProfile, privileges, log, selector;
  createClass = require('react').createClass;
  connect = require('react-redux').connect;
  I = require('immutable');
  ref$ = require('../elements'), iconText = ref$.iconText, roundTime = ref$.roundTime, rndLink = ref$.rndLink, probLink = ref$.probLink, labelSegment = ref$.labelSegment;
