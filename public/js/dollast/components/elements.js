...
(function(){
  var createClass, U, classnames, labeledIcon, iconText, iconInput, ui, field, tabMenu, labelField, dropdown, codeLink, probLink, rndLink, userLink, out$ = typeof exports != 'undefined' && exports || this;
  ...
  out$.probLink = probLink = createClass({
    ...
    render: function(){
      var className;
      className = classnames(this.props.className, 'olive');
      return _(iconText, {
        className: className,
        icon: 'puzzle',
