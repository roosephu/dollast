...
(function(){
  ...
  faqItem = R.createClass({
    dispayName: 'faq-item',
    render: function(){
      return _('div', {}, _('h3', {}, this.props.question), _('h4', {}, this.props.answer), _(hiddenItems, {
  ...
  module.exports = R.createClass({
    ...
    render: function(){
      ...
      return _('div', {}, _('p', {}, "Hi 小朋友们大家好，还记得我是谁吗，对了我就是青年理论计算机科学家 BBL ！（背景音乐：我可是世界上最厉害的……）"), _('p', {}, "为了答谢广大人民群众对我的厚爱，以及老师们拉着我非要我写一个 OJ 出来，我就花了几个星期码了这样一个网站出来 →_→ "), _(faqItem, {
        ...
        answer: _('div', null, "A: ", _('del', null, "M(ongoDB)A(ngularjs)N(odejs)K(oa) ，外加一个 cpp 作为沙盒。目前发现没什么代码量……"), "I used months to refactor the code from Angular.js to React.js. The backend remains to be Koa.js"),
        hidden: ["据说码代码的时间只要学习新姿势的一半，学习新姿势的时间只要调试的一半"]
      }), _('h3', {}, "todo list"), _('ul', {}, (function(){
        var i$, ref$, len$, results$ = [];
