...
var koa, koaJson, koaStatic, koaBodyparser, koaGenericSession, koaPassport, util, koaValidate, koaRouter, koaSend, path, coBusboy, fs, config, app, db, publicRouter, routers;
koa = require('koa');
