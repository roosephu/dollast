...
(function(){
  var koa, koaJson, koaStatic, koaBodyparser, koaGenericSession, koaConditionalGet, koaValidate, koaRouter, koaJade, koaSend, koaEtag, koaJwt, util, path, fs, debug, _, config, db, crypt, app, log, routers, port, out$ = typeof exports != 'undefined' && exports || this;
  koa = require('koa');
