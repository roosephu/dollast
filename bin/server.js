...
var koa, koaJson, koaStatic, koaBodyparser, koaGenericSession, koaValidate, koaRouter, koaSend, koaJwt, util, path, fs, debug, config, db, app, log, routers;
koa = require('koa');
...
app.use(function*(next){
  console.log(this.req.method + " " + this.req.url + " " + util.inspect(this.header.authorization));
  yield next;
});
...
app.use(function*(next){
  log("request", this.request.body, "jwt", this.user);
  yield next;
});
