...
var koa, koaJson, koaStatic, koaBodyparser, koaGenericSession, koaValidate, koaRouter, koaJade, koaSend, koaJwt, util, path, fs, debug, _, config, db, app, log, routers, out$ = typeof exports != 'undefined' && exports || this;
koa = require('koa');
