...
var koa, koaJson, koaStatic, koaBodyparser, koaGenericSession, koaPassport, util, koaValidate, koaRouter, koaSend, path, fs, config, db, app, publicRouter, routers;
koa = require('koa');
...
app.use(function*(next){
  var ref$;
  console.log(this.req.method + " " + this.req.url + " " + util.inspect((ref$ = this.request) != null ? ref$.header : void 8));
  yield next;
});
...
publicRouter.post('/site/login', function*(next){
  var cb, this$ = this;
