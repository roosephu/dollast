...
(function(){
  var mongoose, util, debug, conn, config, log, schema, model, count, out$ = typeof exports != 'undefined' && exports || this;
  ...
  import$(out$, {
    ...
    list: function*(opts){
      ...
      return yield model.find({}, 'outlook.title stat').skip(opts.skip).limit(opts.limit).exec();
    },
