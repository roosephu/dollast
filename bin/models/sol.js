...
(function(){
  var mongoose, mongooseAutoIncrement, debug, moment, conn, permitSchema, db, core, config, atomResultSchema, schema, model, count, log, submit, list, show, toggle, getUserSolvedProblems, getSolutionsInARound, out$ = typeof exports != 'undefined' && exports || this, this$ = this;
  ...
  out$.getUserSolvedProblems = getUserSolvedProblems = function*(uid){
    var query;
  ...
  out$.getSolutionsInARound = getSolutionsInARound = function*(rid){
    var query;
    query = model.aggregate({
      $match: {
        round: rid
