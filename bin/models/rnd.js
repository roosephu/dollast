...
(function(){
  var mongoose, moment, debug, co, _, conn, ref$, permitSchema, canAccess, db, log, schema, lockProb, unlockProb, model, count, funcNextCount, nextCount, modify, show, board, list, remove, publish, out$ = typeof exports != 'undefined' && exports || this, this$ = this;
  ...
  out$.remove = remove = function*(rid){
    this$.ensureAccess(model, rid, 'w');
    yield model.findByIdAndRemove(rid).lean().exec();
  };
