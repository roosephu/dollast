...
var mongoose, mongooseDeepPopulate, mongooseAutoIncrement, util, _, moment, bluebird, co, core, logger, ObjectID, conn, myModel, solModel, probModel, userModel, roundModel, sol, prob, user, rnd, out$ = typeof exports != 'undefined' && exports || this;
...
solModel = (function(superclass){
  ...
  prototype.submit = function*(req, uid){
    ...
    core.judge(req.lang, req.code, sol);
    yield sol.save();
  };
