...
var mongoose, mongooseDeepPopulate, mongooseAutoIncrement, util, _, moment, bluebird, co, debug, core, log, ObjectID, conn, myModel, solModel, probModel, userModel, roundModel, sol, prob, user, rnd, out$ = typeof exports != 'undefined' && exports || this;
...
solModel = (function(superclass){
  ...
  prototype.list = function*(){
    return yield this.model.find({}, '-code -results').populate('prob', 'outlook.title').lean().exec();
  };
...
probModel = (function(superclass){
  ...
  prototype.updData = function*(pid){
    var prob, pairs;
    prob = yield this.model.findById(pid, 'config.dataset').exec();
  ...
  prototype.listDataset = function*(pid){
    var prob;
    prob = yield this.model.findById(pid, "config.dataset").lean().exec();
