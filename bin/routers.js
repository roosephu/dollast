...
var koaRouter, koaJwt, debug, util, path, coBusboy, bluebird, _, config, core, db, tmp, log, dataCtrl, probCtrl, solCtrl, rndCtrl, siteCtrl, userCtrl, paramsValidator, regPriv, router, out$ = typeof exports != 'undefined' && exports || this;
...
siteCtrl = {
  ...
  login: function*(){
    ...
    if (!user) {
      ...
      privList.push('login');
      this.session.privList = _.pairsToObj(privList, (function(){
        var i$, to$, results$ = [];
